...
const Front = () => {
    ...
    const getDocs = async() => {
        const data = await dataBaseService.getBinDocs(0);
    ...
    return (
        ...
        <div ref={reference} className="w-screen h-screen text-white absolute top-0 left-0 bg-transparent overflow-hidden" >
            <div className="flex h-28 w-full items-center justify-end relative">
                <h1 className="text-xl font-semibold absolute bottom-0 left-1/2 -translate-x-[100%]">
                    <Link to="/docs">
                        Documents
                    </Link>
                </h1>
                ...
                <h1 className="text-xl font-semibold absolute bottom-0 left-1/2 mx-5">
                    <Link to="/bin">
                        Bin
                    </Link>
                </h1>
                <div className="flex">
                    ...
                    <HoverCard.Root>
                        ...
                        <HoverCard.Portal>
                            <HoverCard.Content>
                                <div className="text-white rounded-md px-3">
                        ...
                        docs?.map((doc) => {
                            ...
                            if(userId == doc.userId){
                                return (
                                        ...
                                        <Doc reference={reference} title={doc.Title} description={doc.Description} id={doc.$id} image={doc.image}/>
